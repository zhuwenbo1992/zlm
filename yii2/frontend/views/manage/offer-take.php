        ...
        <div class="row white-bg padding5 border-bottom">
            <div class="col-xs-12 black-color text-right padding5" >
                ...
                <?php if($val['take_status']<=2){?>
                    ...
                    <?php } ?>
                    <?php if($val['offer_people']>0) {?>
                    <a style="color:green "href="/manage/take-jian?id=<?=$val['order_take_id']?>" class="btn btn-sm btn-default">已录用<?=$val['offer_people']?>人</a>

                <?php } else {?>
                        <a style="color:green "href="" class="btn btn-sm btn-default">已录用<?=$val['offer_people']?>人</a>
