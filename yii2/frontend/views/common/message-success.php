...
<div class="row wrapper border-bottom white-bg page-heading"
    ...
    <div class="row" style="padding-top: 0px;padding-left: 20px;padding-right: 20px;">
        ...
        <div class="col-xs-6 text-center"><span class="f16">操作成功</span></div>
...
<p class="text-center"><i class="fa fa-check-circle text-success" style="font-size: 100px;"></i></p>
<p class="text-center black-color f18">操作成功！</p>
<p class="text-center f14"><small>页面将在 <?=$sec?> 秒后跳转</small></p>
